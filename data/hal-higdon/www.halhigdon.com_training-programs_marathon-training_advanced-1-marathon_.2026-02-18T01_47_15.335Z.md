- [Transparency is important to us. View our Privacy Policy](https://www.halhigdon.com/privacy-policy).
- [Facebook](https://facebook.com/higdonmarathon)
- [Twitter](https://twitter.com/higdonmarathon)
- [Instagram](https://www.instagram.com/higdonmarathon)

[![](https://www.halhigdon.com/wp-content/uploads/2018/05/HAL_logo-1.png)](https://www.halhigdon.com/)

- [Home](https://www.halhigdon.com/)
- [Run With Hal App](https://www.halhigdon.com/apps/)
- [Training Programs](https://www.halhigdon.com/training/)
  - [All Training Programs](https://www.halhigdon.com/training/)
  - [Marathon Training](https://www.halhigdon.com/training/marathon-training/)
  - [Half Marathon Training](https://www.halhigdon.com/training/half-marathon-training/)
  - [5K Training](https://www.halhigdon.com/training/5k-training/)
  - [8K Training](https://www.halhigdon.com/training/8k-training/)
  - [10K Training](https://www.halhigdon.com/training/10k-training/)
  - [15K & 10 mile Training](https://www.halhigdon.com/training/15k-10-mile-training/)
  - [Post Marathon Training](https://www.halhigdon.com/training/post-marathon-recovery/)
  - [Base Training](https://www.halhigdon.com/training/base-training/)
  - [More Training](https://www.halhigdon.com/training/more-training/)
- [Books](https://www.halhigdon.com/books/)
- [About Hal](https://www.halhigdon.com/about-hal-higdon/)

# Marathon Training : Advanced 1

- [Summary](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#program-about)
- \|
- [Program Details](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#interactive-program-info)
- \|
- [Training Schedule](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#training-schedule)
- \|
- [Additional Programs](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#program-list)
- \|
- [Reviews](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#reviews)
...
This training program for Advanced 1 marathoners offers a progressive buildup--similar to that for the novice and intermediate runners, except you start at 10 miles and peak with three 20-milers. There is also more training at marathon pace (usually Saturdays, the day before Sunday long runs). The major difference, however, is the addition of speedwork. Advanced 1 has one day of speedwork; Advanced 2, two. Pick your poison. Each day, Hal will send you an email telling you what to run and offering a training tip. For more information, check out the [Program Details](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#program-details) below.

#### Get Advanced 1 in our app

For runners who want personalized year-round training, using the Higdon method.

- Start training for free for 14 days — then upgrade to Hal+ to fully customize your plan
- Track your progress with personal stats and charts
- Record your runs with GPS
- Hal adapts to your goals, performance, and schedule
- Train for multiple races at once

[![](https://www.halhigdon.com/wp-content/uploads/2019/09/RunWithHal_Logo_Hor_White.svg)](https://www.halhigdon.com/apps/)...or get the [single-use version](https://home.trainingpeaks.com/purchase/TP-139215).
...
**Typical Week:** 6 Run, 7 Other, 1 Day Off
...
[Leave a review](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#leave-review) [See all reviews](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#reviews)

![](https://www.halhigdon.com/wp-content/uploads/2018/04/runner.png)
...
Speed sessions consist of hill repeats, interval training and tempo runs in various combinations. Explanations on how to perform each workout follow below and in the daily email messages for those signing up for an interactive program through [TrainingPeaks](https://www.trainingpeaks.com/coach/halhigdon#trainingplans). Admittedly, not everybody wants to do speedwork, or enjoys going to the track. If that is your philosophy, you are better off following one of my intermediate programs. The advanced schedules (1 and 2) are designed only for the hard core, those willing to take it to the limit. Only a small percentage of today’s runners classify themselves as “Advanced” or want to follow this demanding a schedule. If that is you, welcome aboard.

I might add that you can be male or female, a 2:30 marathoner or a 4:30 marathoner and still train as an advanced runner. Speed doesn’t count. Sex doesn’t count. Age doesn’t count. What decides whether or not you are an advanced runner is your background and your familiarity with this type of training plus your attitude. If this is your first marathon, regardless of your talent, consider following the [Novice 2](https://www.trainingpeaks.com/training-plans/running/marathon/tp-4400/hal-higdon-marathon-novice-2) program and simply set as your goal finishing, rather than finishing fast. See you a couple of marathons from now. If you haven’t done the various types of speedwork included in this program, it’s also Bye Bye. You do not want to begin speedwork in a marathon program if you have not done it before. For an introduction to speedwork, check the shorter-distance training schedules on this Web site. All of my training programs are available in interactive versions (more tips, more instructions), which you can get from [TrainingPeaks](https://www.trainingpeaks.com/coach/halhigdon#trainingplans).

Here is an explanation of the type of training you will encounter in the Advanced 1 program:

**Long Runs**: The key to all my marathon programs are the long runs on weekends, which build from 10 miles in the first week (Week 1) to a maximum of 20 miles, done three times (Weeks 11, 13 and 15). Although some experienced runners do train longer, I see no advantage in doing 23, 26 or even 31 mile runs. (I’ve tried that myself in the past, and it just wore me out.) Save your energy and concentrate on quality runs the rest of the week. Consistency is most important. You can skip an occasional workout, or juggle the schedule depending on other commitments, but do not cheat on the long runs. Notice that although the weekly long runs get progressively longer, every third week is a “stepback” week, where we reduce mileage to allow you to gather strength for the next push upward. Rest is an important component of any training program.
...
- [Miles](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#miles)
- [KMs](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#kilometers)
- [Print](https://www.halhigdon.com/wp-content/uploads/2018/04/Advanced-1-Marathon-Printable.pdf)
...
| Week | Mon | Tue | Wed | Thu | Fri | Sat | Sun |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 4.8 km run | 8.1 km run | 4.8 km run | 3 x hill | Rest | 8.1 km pace | 16.1 |
| 2 | 4.8 km run | 8.1 km run | 4.8 km run | 30 tempo | Rest | 8.1 km run | 17.7 |
| 3 | 4.8 km run | 9.7 km run | 4.8 km run | 4 x 800 | Rest | 9.7 km pace | 12.9 |
| 4 | 4.8 km run | 9.7 km run | 4.8 km run | 4 x hill | Rest | 9.7 km pace | 21.0 |
| 5 | 4.8 km run | 11.3 km run | 4.8 km run | 35 tempo | Rest | 11.3 km run | 22.5 |
| 6 | 4.8 km run | 11.3 km run | 4.8 km run | 5 x 800 | Rest | 11.3 km pace | 16.1 |
| 7 | 4.8 km run | 12.9 km run | 6.4 km run | 5 x hill | Rest | 12.9 km pace | 1.6 |
| 8 | 4.8 km run | 12.9 km run | 6.4 km run | 40 tempo | Rest | 12.9 km run | 27.4 |
| 9 | 4.8 km run | 14.5 km run | 6.4 km run | 6 x 800 | Rest | Rest | **Half Marathon** |
| 10 | 4.8 km run | 14.5 km run | 6.4 km run | 6 x hill | Rest | 14.5 km pace | 30.6 |
| 11 | 6.4 km run | 16.1 km run | 8.1 km run | 45 tempo | Rest | 16.1 km run | 32.2 |
| 12 | 6.4 km run | 9.7 km run | 8.1 km run | 7 x 800 | Rest | 9.7 km pace | 19.3 |
| 13 | 6.4 km run | 16.1 km run | 8.1 km run | 7 x hill | Rest | 16.1 km pace | 32.2 |
| 14 | 8.1 km run | 9.7 km run | 8.1 km run | 45 tempo | Rest | 9.7 km run | 19.3 |
| 15 | 8.1 km run | 16.1 km run | 8.1 km run | 8 x 800 | Rest | 16.1 km pace | 32.2 |
| 16 | 8.1 km run | 12.9 km run | 8.1 km run | 6 x hill | Rest | 6.4 km pace | 19.3 |
...
- [Novice 2](https://www.halhigdon.com/training-programs/marathon-training/novice-2-marathon/)
- [Intermediate 1](https://www.halhigdon.com/training-programs/marathon-training/intermediate-1-marathon/)
- [Intermediate 2](https://www.halhigdon.com/training-programs/marathon-training/intermediate-2-marathon/)
- [Advanced 1](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/)
- [Advanced 2](https://www.halhigdon.com/training-programs/marathon-training/advanced-2-marathon/)
- [Novice Supreme](https://www.halhigdon.com/training-programs/marathon-training/novice-supreme/)
- [Personal Best](https://www.halhigdon.com/training-programs/marathon-training/personal-best/)
- [Senior](https://www.halhigdon.com/training-programs/marathon-training/senior/)
- [Marathon 3](https://www.halhigdon.com/training-programs/marathon-training/marathon-3/)
...
- [DOPEY CHALLENGE](https://www.halhigdon.com/training-programs/marathon-training/dopey-challenge/)
...
- [10K Training](https://www.halhigdon.com/training/10k-training/)
- [15K & 10 Mile Training](https://www.halhigdon.com/training/15k-10-mile-training/)
- [Post Marathon Recovery](https://www.halhigdon.com/training/post-marathon-recovery/)
- [Base Training](https://www.halhigdon.com/training/base-training/)
- [More Training](https://www.halhigdon.com/training/more-training/)

## Books

- [![](https://www.halhigdon.com/wp-content/uploads/2018/04/Hal-Higdon-Marathon-Cover-1.jpg)](https://www.halhigdon.com/books/)
- [![](https://www.halhigdon.com/wp-content/uploads/2018/04/book1.png)](https://www.halhigdon.com/books/)
...
I have run 10K races for 15 years and last year I just decided to start running half and full marathons. I followed all your training and succesfully finished my first marathon with no problems, 4h 10min. This year my goal is to do it under 4h. Thank you very much for all your info![Show more](https://www.halhigdon.com/training-programs/marathon-training/advanced-1-marathon/#)
...
- [About Hal](https://www.halhigdon.com/about-hal-higdon/)
- [Apps](https://www.halhigdon.com/apps/)
- [Books](https://www.halhigdon.com/books/)
- [Privacy Policy](https://www.halhigdon.com/privacy-policy/)
- [Our New Site](https://www.halhigdon.com/welcome/)

### Contact Info

- [@higdonmarathon](https://x.com/higdonmarathon)
- [Run With Hal app support](https://runwithhal.zendesk.com/hc/en-us)
- [TrainingPeaks Help Center](https://help.trainingpeaks.com/hc/en-us/requests/new?ticket_form_id=2830)
- [info@halhigdon.com](mailto:info@halhigdon.com)

All contents © Hal Higdon, LLC 2026. All rights reserved.

[Digital Momentum](https://www.digitalmomentum.com/)

Website powered by [Digital Momentum](https://www.digitalmomentum.com/)
