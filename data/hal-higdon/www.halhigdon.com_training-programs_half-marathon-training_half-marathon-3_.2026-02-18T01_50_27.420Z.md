...
- [Summary](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#program-about)
- \|
- [Program Details](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#interactive-program-info)
- \|
- [Training Schedule](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#training-schedule)
- \|
- [Additional Programs](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#program-list)
- \|
- [Reviews](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#reviews)
...
This plan is not available in the RunWithHal app, but you can still get the [interactive version](https://www.trainingpeaks.com/training-plans/running/half-marathon/tp-91847/hal-higdon-half-marathon-3-hm3) through TrainingPeaks. Or, explore more training options in the app:

[![](https://www.halhigdon.com/wp-content/uploads/2019/09/RunWithHal_Logo_Hor_White.svg)](https://www.halhigdon.com/apps/)
...
**Typical Week:** 2 Day Off, 3 Run, 2 X-Train
...
[Leave a review](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#leave-review) [See all reviews](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#reviews)

![](https://www.halhigdon.com/wp-content/uploads/2018/04/runner.png)

#### Hal on his Half Marathon 3 (HM3) Program

**Introduction:** In my latest book, _Hal Higdon’s Half Marathon Training_ (published by [Human Kinetics](http://www.humankinetics.com/products/all-products/hal-higdons-half-marathon-training)), I created several new training programs. Here is one of them: Half Marathon 3 (HM3). HM3 is designed for experienced runners, those of you who have been running for several years, who enjoy running road races between 5-K and the marathon, but who find it difficult to run more often than three times a week. Perhaps it is because of a lack of time or perhaps it is because too frequent running raises the risk of injury. If you are one of those runners, HM3 is designed for you. ( [Check also Marathon 3 for marathon runners](https://www.trainingpeaks.com/training-plans/running/marathon/tp-9629/hal-higdon-marathon-3).)
...
**Races:** I plugged races at 5-K and 10-K into the schedule in Weeks 6 and 9. Nothing magic about those distances and those days. Feel free to modify the program based on the local racing schedule. Use races to test your fitness allowing you to predict more accurately your half marathon pace. During race weeks, you run slightly different mileage midweek.
...
- [Miles](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#miles)
- [KMs](https://www.halhigdon.com/training-programs/half-marathon-training/half-marathon-3/#kilometers)

| Week | Mon | Tue | Wed | Thu | Fri | Sat | Sun |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Rest | 4 mi run | 30 min cross | 3 mi run | Rest | 6 mi run | 30 min cross |
| 2 | Rest | 4 mi run | 35 min cross | 30 min trempo | Rest | 6 mi run | 35 min cross |
| 3 | Rest | 5 mi run | 40 min cross | 3 mi pace | Rest | 7 mi run | 40 min cross |
| 4 | Rest | 5 mi run | 45 min cross | 4 mi run | Rest | 7 mi run | 45 min cross |
| 5 | Rests | 4 mi run | 50 min cross | 40 min tempo | Rest | 8 mi run | 50 min cross |
| 6 | Rest | 4 mi run | 30 min cross | 3 mi pace | Rest or easy run | Rest | **5-K Race** |
| 7 | Rest | 6 mi run | 50 min cross | 5 mi run | Rest | 9 mi run | 50 min cross |
| 8 | Rest | 6 mi run | 50 min cross | 50 min tempo | Rest | 9 mi run | 50 min cross |
| 9 | Rest | 4 mi run | 30 min cross | 3 mi pace | Rest or easy run | Rest | **10-K Race** |
| 10 | Rest | 6 mi run | 60 min cross | 6 mi run | Rest | 10 mi run | 60 min cross |
| 11 | Rest | 6 mi run | 60 min cross | 60 min tempo | Rest | 10 mi run | 60 min cross |
| 12 | Rest | 4 mi run | 30 min cross | 3 mi pace | Rest | Rest | **Half Marathon** |

| Week | Mon | Tue | Wed | Thu | Fri | Sat | Sun |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Rest | 6.4 km run | 30 min cross | 4.8 km run | Rest | 9.7 km run | 30 min cross |
| 2 | Rest | 6.4 km run | 35 min cross | 30 min trempo | Rest | 9.7 km run | 35 min cross |
| 3 | Rest | 8.1 km run | 40 min cross | 4.8 km pace | Rest | 11.3 km run | 40 min cross |
| 4 | Rest | 8.1 km run | 45 min cross | 6.4 km run | Rest | 11.3 km run | 45 min cross |
| 5 | Rests | 6.4 km run | 50 min cross | 40 min tempo | Rest | 12.9 km run | 50 min cross |
| 6 | Rest | 6.4 km run | 30 min cross | 4.8 km pace | Rest or easy run | Rest | **5-K Race** |
| 7 | Rest | 9.7 km run | 50 min cross | 8.1 km run | Rest | 14.5 km run | 50 min cross |
| 8 | Rest | 9.7 km run | 50 min cross | 50 min tempo | Rest | 14.5 km run | 50 min cross |
| 9 | Rest | 6.4 km run | 30 min cross | 4.8 km pace | Rest or easy run | Rest | **10-K Race** |
| 10 | Rest | 9.7 km run | 60 min cross | 9.7 km run | Rest | 16.1 km run | 60 min cross |
